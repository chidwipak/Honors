...
from real_model_evaluators import get_real_model_evaluator
...
class RealMedFrameQAEvaluator:
    ...
    def __init__(self, data_dir, models_dir, results_dir, device=None):
        ...
        self.model_configs = {
            ...
            'Biomedical-LLaMA': {
                'path': os.path.join(models_dir, 'Biomedical-LLaMA'),
                'batch_size': 4
            },
            'LLaVA-Med': {
                'path': os.path.join(models_dir, 'LLaVA-Med'),
                'batch_size': 4
            },
            'MedGemma': {
            ...
            'PMC-VQA': {
                'path': os.path.join(models_dir, 'PMC-VQA'),
                'batch_size': 4
            },
            'Qwen2.5-VL': {
                'path': os.path.join(models_dir, 'Qwen2.5-VL'),
                'batch_size': 4
            }
        }
